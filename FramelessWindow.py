...
from PyQt5.QtGui import QFont, QEnterEvent, QPainter, QColor, QPen, QMouseEvent
...
class WelcomeForm(QtWidgets.QWidget, Ui_Form):
    ...
    def init_menu(self):
        ...
        self.action2 = self.context_menu.addAction('退出程序', self.close)
...
if __name__ == '__main__':
    ...
    # w.setWidget(WelcomeForm(w))  # 把自己的窗口添加进来
    w.show()
    sys.exit(app.exec_())