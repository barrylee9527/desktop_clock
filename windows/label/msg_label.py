...
from PySide6.QtGui import QPen, QPainterPath, QPainter, QColor, QFont
...
class MsgLabel(QWidget):
    BackgroundColor = QColor(195, 195, 195, 150)
    BorderColor = QColor(150, 150, 150, 150)
    ...
    def show(self):
        ...
        startPos = QPoint(x+int(x2/2)-int(self.width()/2), y+int(y2/3))
        endPos = QPoint(x+int(x2/2)-int(self.width()/2), y+int(y2/3)-self.height()*3-5)
        self.move(startPos)
        # 初始化动画
    ...
    def ShowMsgEx(owner, text):
        ...
        data = MsgLabel(owner)
        data.setText(text)
        data.setStyleSheet("color:green")
        data.show()
    ...
    # data.OpenPicture()
    # data.OpenPicture(data)
    # data.OpenPicture(data, ".")
    # data.OpenPicture(data, "./")
    # data.OpenPicture(data, "./test.jpg")
    # data.OpenPicture(data, "./test.png")
    # data.OpenPicture(data, "./test.gif")
    # data.OpenPicture(data, "./test.bmp")
    # data.OpenPicture(data, "./test.ico")
    # data.OpenPicture(data, "./test.cur")
    # data.OpenPicture(data, "./test.xbm")
    # data.OpenPicture(data, "./test.xpm")
    # data.OpenPicture(data, "./test.svg")
    # data.OpenPicture(data, "./test.svgz")
    # data.OpenPicture(data, "./test.tiff")
    # data.OpenPicture(data, "./test.tif")
    # data.OpenPicture(data, "./test.pbm")
    # data.OpenPicture(data, "./test.pgm")
    # data.OpenPicture(data, "./test.ppm")
    # data.OpenPicture(data, "./test.pnm")
    # data.OpenPicture(data, "./test.pbm")
    # data.OpenPicture(data, "./test.pgm")
    # data.OpenPicture(data, "./test.ppm")
    # data.OpenPicture(data, "./test.pnm")
